...
/**
 * free_tokens - free the global op_tok array of a string
 */
void free_tokens(void)
{
	size_t i = 0;
...
/**
 * is_empty_line - check if line read from getline only contains delimination
 * @line: a ponter
 ...
 * @script_fd: file scriptor for open monty bytecode
 *
 * Return: (EXIT_SUCCESS) on success
 * and on error the respective error code
 */
int run_monty(FILE *script_fd)
{
	stack_t *stack = NULL;
